...
type CreateDesk struct {
	...
	Pub      bool       `protobuf:"varint,13,opt,name=Pub,proto3" json:"Pub,omitempty"`
	Minimum  int64      `protobuf:"varint,14,opt,name=minimum,proto3" json:"minimum,omitempty"`
	Maximum  int64      `protobuf:"varint,15,opt,name=maximum,proto3" json:"maximum,omitempty"`
	Mode     uint32     `protobuf:"varint,16,opt,name=mode,proto3" json:"mode,omitempty"`
	Multiple uint32     `protobuf:"varint,17,opt,name=multiple,proto3" json:"multiple,omitempty"`
}
...
func (m *CreateDesk) GetMinimum() int64 {
	if m != nil {
		return m.Minimum
	}
	return 0
...
func (m *CreateDesk) GetMaximum() int64 {
	if m != nil {
		return m.Maximum
	}
	return 0
...
func (m *CreateDesk) GetMode() uint32 {
	if m != nil {
		return m.Mode
	}
	return 0
...
func (m *CreateDesk) GetMultiple() uint32 {
	if m != nil {
		return m.Multiple
	}
	return 0
...
func (m *CreateDesk) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Minimum != 0 {
		dAtA[i] = 0x70
		i++
		i = encodeVarintActorDesk(dAtA, i, uint64(m.Minimum))
	}
	if m.Maximum != 0 {
		dAtA[i] = 0x78
		i++
		i = encodeVarintActorDesk(dAtA, i, uint64(m.Maximum))
	}
	if m.Mode != 0 {
		dAtA[i] = 0x80
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintActorDesk(dAtA, i, uint64(m.Mode))
	}
	if m.Multiple != 0 {
		dAtA[i] = 0x88
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintActorDesk(dAtA, i, uint64(m.Multiple))
	}
	return i, nil
}
...
func (m *CreateDesk) Size() (n int) {
	...
	if m.Minimum != 0 {
		n += 1 + sovActorDesk(uint64(m.Minimum))
	}
	if m.Maximum != 0 {
		n += 1 + sovActorDesk(uint64(m.Maximum))
	}
	if m.Mode != 0 {
		n += 2 + sovActorDesk(uint64(m.Mode))
	}
	if m.Multiple != 0 {
		n += 2 + sovActorDesk(uint64(m.Multiple))
	}
	return n
}
...
var fileDescriptorActorDesk = []byte{
	...
	,
}
