...
func (*LoginPrizeUpdate) Descriptor() ([]byte, []int) { return fileDescriptorActorRole, []int{36} }
...
func (*GetRoomRecord) Descriptor() ([]byte, []int) { return fileDescriptorActorRole, []int{37} }
...
var fileDescriptorActorRole = []byte{
	...
	,
}
