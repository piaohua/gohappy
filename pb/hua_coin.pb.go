...
// 换房间
type CJHCoinChangeRoom struct {
}

func (m *CJHCoinChangeRoom) Reset()                    { *m = CJHCoinChangeRoom{} }
func (*CJHCoinChangeRoom) ProtoMessage()               {}
func (*CJHCoinChangeRoom) Descriptor() ([]byte, []int) { return fileDescriptorHuaCoin, []int{14} }

type SJHCoinChangeRoom struct {
	Error ErrCode `protobuf:"varint,1,opt,name=error,proto3,enum=pb.ErrCode" json:"error,omitempty"`
}

func (m *SJHCoinChangeRoom) Reset()                    { *m = SJHCoinChangeRoom{} }
func (*SJHCoinChangeRoom) ProtoMessage()               {}
func (*SJHCoinChangeRoom) Descriptor() ([]byte, []int) { return fileDescriptorHuaCoin, []int{15} }

func (m *SJHCoinChangeRoom) GetError() ErrCode {
	if m != nil {
		return m.Error
	}
	return OK
...
func (m *SJHPushDrawCoin) Reset()                    { *m = SJHPushDrawCoin{} }
func (*SJHPushDrawCoin) ProtoMessage()               {}
func (*SJHPushDrawCoin) Descriptor() ([]byte, []int) { return fileDescriptorHuaCoin, []int{16} }

func (m *SJHPushDrawCoin) GetRtype() uint32 {
	if m != nil {
		return m.Rtype
	}
	return 0
...
func (m *SJHPushDrawCoin) GetSeat() uint32 {
	if m != nil {
		return m.Seat
	}
	return 0
...
func (m *SJHPushDrawCoin) GetUserid() string {
	if m != nil {
		return m.Userid
	}
	return ""
...
func (m *SJHPushDrawCoin) GetCoin() int64 {
	if m != nil {
		return m.Coin
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*CJHCoinChangeRoom)(nil), "pb.CJHCoinChangeRoom")
	proto.RegisterType((*SJHCoinChangeRoom)(nil), "pb.SJHCoinChangeRoom")
	proto.RegisterType((*SJHPushDrawCoin)(nil), "pb.SJHPushDrawCoin")
}
...
func (this *CJHCoinChangeRoom) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CJHCoinChangeRoom)
	if !ok {
		that2, ok := that.(CJHCoinChangeRoom)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SJHCoinChangeRoom) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SJHCoinChangeRoom)
	if !ok {
		that2, ok := that.(SJHCoinChangeRoom)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *SJHPushDrawCoin) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SJHPushDrawCoin)
	if !ok {
		that2, ok := that.(SJHPushDrawCoin)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CJHCoinChangeRoom) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 4)
	s = append(s, "&pb.CJHCoinChangeRoom{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *SJHCoinChangeRoom) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&pb.SJHCoinChangeRoom{")
	s = append(s, "Error: "+fmt.Sprintf("%#v", this.Error)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *SJHPushDrawCoin) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&pb.SJHPushDrawCoin{")
...
func (m *CJHCoinChangeRoom) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CJHCoinChangeRoom) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SJHCoinChangeRoom) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SJHCoinChangeRoom) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SJHPushDrawCoin) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SJHPushDrawCoin) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Rtype != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintHuaCoin(dAtA, i, uint64(m.Rtype))
	}
	if m.Seat != 0 {
		dAtA[i] = 0x10
		i++
	...
	if m.Coin != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintHuaCoin(dAtA, i, uint64(m.Coin))
	}
	return i, nil
}
...
func (m *CJHCoinChangeRoom) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *SJHCoinChangeRoom) Size() (n int) {
	var l int
	_ = l
	if m.Error != 0 {
		n += 1 + sovHuaCoin(uint64(m.Error))
...
func (m *SJHPushDrawCoin) Size() (n int) {
	var l int
	_ = l
	if m.Rtype != 0 {
		n += 1 + sovHuaCoin(uint64(m.Rtype))
	}
	if m.Seat != 0 {
		n += 1 + sovHuaCoin(uint64(m.Seat))
	}
...
func (this *CJHCoinChangeRoom) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CJHCoinChangeRoom{`,
		`}`,
	}, "")
	return s
}
func (this *SJHCoinChangeRoom) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SJHCoinChangeRoom{`,
		`Error:` + fmt.Sprintf("%v", this.Error) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SJHPushDrawCoin) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SJHPushDrawCoin{`,
...
func (m *CJHCoinChangeRoom) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CJHCoinChangeRoom: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CJHCoinChangeRoom: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *SJHCoinChangeRoom) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SJHCoinChangeRoom: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SJHCoinChangeRoom: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *SJHPushDrawCoin) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SJHPushDrawCoin: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SJHPushDrawCoin: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorHuaCoin = []byte{
	...
	,
}
