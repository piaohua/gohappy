...
// 语音房间投票的信息
type NNRoomVoice struct {
	Seat     uint32   `protobuf:"varint,1,opt,name=seat,proto3" json:"seat,omitempty"`
	Agree    []uint32 `protobuf:"varint,2,rep,packed,name=agree" json:"agree,omitempty"`
	Disagree []uint32 `protobuf:"varint,3,rep,packed,name=disagree" json:"disagree,omitempty"`
}

func (m *NNRoomVoice) Reset()                    { *m = NNRoomVoice{} }
func (*NNRoomVoice) ProtoMessage()               {}
func (*NNRoomVoice) Descriptor() ([]byte, []int) { return fileDescriptorNiuPub, []int{12} }

func (m *NNRoomVoice) GetSeat() uint32 {
	if m != nil {
		return m.Seat
	}
	return 0
...
func (m *NNRoomVoice) GetAgree() []uint32 {
	if m != nil {
		return m.Agree
	}
	return nil
...
func (m *NNRoomVoice) GetDisagree() []uint32 {
	if m != nil {
		return m.Disagree
	}
	return nil
...
func (*NNDealerList) Descriptor() ([]byte, []int) { return fileDescriptorNiuPub, []int{13} }
...
func (*NNFreeTrend) Descriptor() ([]byte, []int) { return fileDescriptorNiuPub, []int{14} }
...
func (*NNFreeWiner) Descriptor() ([]byte, []int) { return fileDescriptorNiuPub, []int{15} }
...
func (*NNFreeRole) Descriptor() ([]byte, []int) { return fileDescriptorNiuPub, []int{16} }
...
func (*NNRecordList) Descriptor() ([]byte, []int) { return fileDescriptorNiuPub, []int{17} }
...
func init() {
	...
	proto.RegisterType((*NNRoomVoice)(nil), "pb.NNRoomVoice")
...
func (this *NNRoomVoice) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*NNRoomVoice)
	if !ok {
		that2, ok := that.(NNRoomVoice)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *NNRoomVoice) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&pb.NNRoomVoice{")
	s = append(s, "Seat: "+fmt.Sprintf("%#v", this.Seat)+",\n")
	s = append(s, "Agree: "+fmt.Sprintf("%#v", this.Agree)+",\n")
	s = append(s, "Disagree: "+fmt.Sprintf("%#v", this.Disagree)+",\n")
	s = append(s, "}")
...
func (m *NNRoomVoice) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *NNRoomVoice) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Agree) > 0 {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintNiuPub(dAtA, i, uint64(j15))
	...
	if len(m.Disagree) > 0 {
		...
		dAtA[i] = 0x1a
		i++
		i = encodeVarintNiuPub(dAtA, i, uint64(j17))
...
func (this *NNRoomVoice) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&NNRoomVoice{`,
		`Seat:` + fmt.Sprintf("%v", this.Seat) + `,`,
		`Agree:` + fmt.Sprintf("%v", this.Agree) + `,`,
		`Disagree:` + fmt.Sprintf("%v", this.Disagree) + `,`,
		`}`,
...
func (m *NNRoomVoice) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NNRoomVoice: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NNRoomVoice: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorNiuPub = []byte{
	...
	,
	...
	,
}
