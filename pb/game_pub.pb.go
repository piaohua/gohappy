...
type Rank struct {
	...
	Weixin   string `protobuf:"bytes,6,opt,name=weixin,proto3" json:"weixin,omitempty"`
}
...
type Activity struct {
	...
	Over      bool   `protobuf:"varint,8,opt,name=over,proto3" json:"over,omitempty"`
}
...
func (this *Activity) GoString() string {
	...
	s = append(s, "Type: "+fmt.Sprintf("%#v", this.Type)+",\n")
	s = append(s, "Over: "+fmt.Sprintf("%#v", this.Over)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Rank) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Weixin) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintGamePub(dAtA, i, uint64(len(m.Weixin)))
...
var fileDescriptorGamePub = []byte{
	...
	,
}
